...
class OffDiagonalComponents:
    ...
    def generate_lx(self, state1, state2, functional_instance, lx, factor='i'):
        lx_object = LX(state1, state2, functional_instance, lx=lx, factor=factor)
        self.components[lx_object.name] = lx_object
